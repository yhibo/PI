...
#### Plot del campo de desplazamiento superpuesto con la segmentación

plt.figure(figsize=(10,10))
plt.title('Plot del campo de desplazamiento superpuesto con la segmentación')
#plt.quiver(montage(dfi[10][0,:,:,:]), montage(dfi[10][1,:,:,:]), scale=100000000)
plt.imshow(mask[10][6,:,:])
plt.quiver(dfi[10][0,6,:,:], dfi[10][1,6,:,:], scale=1000, angles='xy')

#### Plot comparando el strain calculado por DeepStrain con nuestra metodología (usando un promedio global sobre el miocardio)    

plt.figure()
plt.title('Plot comparando el strain calculado por DeepStrain con nuestra metodología (usando un promedio global sobre el miocardio)')
...
plt.title('Plot para observar el strain calculado con nuestra metodología en el miocardio')
plt.figure(figsize=(10,10))
...
plt.figure(figsize=(10,10))
plt.title('Visualización del strain calculado con Deepstrain superpuesto con la máscara del miocardio correspondiente')
...
import matplotlib.pyplot as plt
plt.figure(figsize=(10,10))
plt.title('Visualización de el campo de desplazamiento con los vectores de la parte radial del sistema de coordenadas locales')
